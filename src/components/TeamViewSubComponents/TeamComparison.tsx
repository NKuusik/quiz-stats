...
function TeamComparison({teams, comparisonTeamHandler, collapseWidth}: MyProps) {
  ...
  if (viewActive) {
    ...
    menuBar = <MenuBar category={Object.keys(teams)} choice={(comparedTeamName: string) => comparisonTeamHandler(comparedTeamName)} viewType={'comparison'} collapseFunction={() => { console.log('Not used for comparison menubar'); }}/>;
  }
